    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Hardware.sensor')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('actuator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Hardware.actuator')),
                ('greenhouse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Greenhouses.greenhouse')),
            ],
        ),
    ]
